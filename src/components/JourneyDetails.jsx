            ...
            <div>
              ...
              <div className="w-full flex gap-8 space-y-6">
                ...
                <div className="w-1/2">
                  <TextInput
                    ...
                    onChange={(e) =>
                      setTripDetails({ tripDetails, ecNumber: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div>
                <SelectInput
                  ...
                  onChange={(e) =>
                    setTripDetails({ tripDetails, grade: e.target.value })
                  }
                />
              </div>
              ...
              <div>
                <TextArea
                  ...
                  onChange={(e) =>
                    setTripDetails({ tripDetails, purpose: e.target.value })
                  }
                />
              </div>
          ...
          {step === 2 && (
            <div>
              ...
              {routes.map((route, index) => (
                <div
                  key={index}
                  className="border border-BLUE p-4 rounded-lg mb-4"
                >
                  ...
                  <SelectInput
                    ...
                    onChange={(e) =>
                      setTripDetails({ tripDetails, departure: e.target.value })
                    }
                  />
                  ...
                  <PerDiemInput
                    value={
                      tripDetails.perDiem ||
                      (destinationOutBound
                        ? countryRates[destinationOutBound]
                        : "")
                    }
                    onChange={(e) =>
                      setTripDetails({ tripDetails, perDiem: e.target.value })
                    }
                  />
              ...
              <div className="flex justify-start my-4">
                ...
                <Button
                  label="Delete Route"
                  onClick={() => deleteRoute(routes.length - 1)}
                />
              </div>
            ...
            <div>
              ...
              {returnRoutes.map((route, index) => (
                ...
                >
                  ...
                  <label className="block text-DARKGRAY-xl font-medium mb-2">
                    Per Diem rate for Destination Country
                  </label>
                  <input
                    type="text"
                    ...
                    value={
                      tripDetails.perDiem ||
                      (returnDestination ? countryRates[returnDestination] : "")
                    }
                  />
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      setTripDetails({
                        tripDetails,
                        returnArrivalDate: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div className="w-full flex gap-3 mt-4 ">
                <Button
                  label="Add Another Return Route"
                  onClick={addReturnRoute}
                />
                <Button
                  label="Delete Route"
                  onClick={() => deleteRoute(returnRoutes.length - 1)}
                />
              </div>
          ...
          {step === 4 && (
            <div>
              <SelectInput
                ...
                onChange={(e) =>
                  setTripDetails({ tripDetails, source: e.target.value })
                }
              />
